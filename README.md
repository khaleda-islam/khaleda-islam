...
**Nov 2019 – Dec 2022 | Dhaka, Bangladesh**

- Developed and maintained enterprise broker back-office applications using **C#, ASP.NET MVC, SQL Server**
- Worked directly with clients to gather requirements and resolve production issues
- Designed custom reports using **SQL Server, Oracle, Crystal Reports**
- Deployed applications and performed client data migration
...
> 💡 “Continuous learning, curiosity, and innovation drive great software development.”
